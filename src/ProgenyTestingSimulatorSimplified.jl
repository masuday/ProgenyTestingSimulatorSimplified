...
export initial_data, generate_founders!, test_mating!, regular_mating!, et_mating!,
     list_of_top_young_bulls,
     update_inbreeding!, assign_phenotype!, show_current_population, assign_cow_herd!
